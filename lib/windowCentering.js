...
export class WindowCentering {
    ...
    adjustFrame() {
        ...
        const usableScreen = {
            x: screen.x,
            y: screen.y + panelHeight,
            width: screen.width,
            height: screen.height - panelHeight
        };
        const centerPos = this._calcCenterPos(targetSize, usableScreen);
        ...
        const targetX = shouldMove ? centerPos.centerX : x;
        const targetY = shouldMove ? centerPos.centerY : y;
        const targetW = shouldResize ? targetSize.width : width;
        const targetH = shouldResize ? targetSize.height : height;
